...
const Katalog = () => {
  ...
  const [filteredItems, setFilteredItems] =
    useState<KatalogItem[]>(katalogItems);
  ...
  return (
    <>
      <main className="min-h-screen pt-20">
        <Header
          title="  Katalog"
          subtitle="  Temukan peralatan camping berkualitas untuk petualanganmu. Semua peralatan bersih, terawat, dan siap pakai."
        />
          ...
          <div className="container-main">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  Hubungi via WhatsApp untuk booking cepat dan konfirmasi
                  instan.
                </p>
              </div>
            </div>
